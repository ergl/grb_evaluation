...
mergeSite() {
    ...
    # Rubis operations
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "register-user-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "browse-categories-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "search-items-in-category-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "browse-regions-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "browse-categories-in-region-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "search-items-in-region-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "view-item-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "view-user-info-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "view-bid-history-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "buy-now-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "store-buy-now-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "put-bid-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "store-bid-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "put-comment-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "store-comment-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "select-category-to-sell-item-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "register-item-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "about-me-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "get-auctions-ready-for-close-latencies.cvs"
    mergeSiteLatency "${folder}" "${glob}" "${token_dir}" "close-auction-latencies.cvs"
}
